...
def main():
  ...
  dotenv_path = os.path.expanduser("~/melissa_env.txt")

  # Load environment variables from the file
  load_dotenv(dotenv_path)

  # Access the environment variable and assign it to the 'license' variable
  license = os.getenv("MELISSA_KEY")

  # Print or use the 'license' variable as needed
